...
function Main() {
  ...
  return (
    ...
    <MainContaier>  
      ...
      <Container>
        ...
        {perosnalsx &&
            perosnalsx.map((personal, index) => (
              <div>
        <LogoComponent theme={click ? 'dark' : 'light'}  name={personal.firstname} />
       </div>
            ))}
        ...
        <Work to={"/theme3/work/" + id} click={click}>
          <motion.h2
            initial={{
              x: -200,
              transition: { type: 'spring', duration: 1.5, delay: 1 },
        ...
        <BottomBar>
          <About to={"/theme3/about/" + id} click={click}>
            <motion.h2
              initial={{
                y: 200,
                transition: { type: 'spring', duration: 1.5, delay: 1 },
      ...
      {click ? <Intro click={click} biography = {personal.biography} chara={personal.characteristics} /> : null}
